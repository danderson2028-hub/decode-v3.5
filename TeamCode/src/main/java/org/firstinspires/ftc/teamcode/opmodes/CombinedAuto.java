...
public class CombinedAuto extends NextFTCOpMode {
    ...
    private final Pose shootPose = new Pose(57.5,15, Math.toRadians(135));
    ...
    private final Pose leavePose = new Pose(51,24, Math.toRadians(135));
    ...
    private Command auto(){
        return new SequentialGroup(
                ...
                Transfer.INSTANCE.runTransfer(0.4),
                new Delay(.9),
                Transfer.INSTANCE.runTransfer(.7),
                new Delay(.5),
